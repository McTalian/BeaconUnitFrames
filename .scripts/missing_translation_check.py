...
def compare_translations(reference_dict, target_dict, locale):
    ...
    if missing_keys:
        ...
        markdown_report += "\n".join(missing_keys)
        markdown_report += "\n</details>\n\n"
        markdown_report += f"\n\n_You can even make changes for [this file](https://github.com/McTalian/BeaconUnitFrames/edit/main/locale/{locale}) and open a PR directly in your browser_\n\n"
...
def main():
    locale_dir = "BeaconUnitFrames/locale"
