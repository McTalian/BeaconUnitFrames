...
---@class BUFPet.Health.CenterText: BUFConfigHandler, BUFFontString
...
ns.options.args.unitFrames.args.pet.args.healthBar.args.centerText = centerTextHandler.optionsTable
